...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[8])
{
	...
	//Пока нужен только цвет
	materials[0].Color = vec3(0.0, 0.0, 0.3);
	materials[0].LightCoeffs = vec4(lightCoefs);
	materials[0].ReflectionCoef = 0.5;
	materials[0].RefractionCoef = 1.0;
	materials[0].MaterialType = DIFFUSE;
	
	materials[1].Color = vec3(0.6, 0.6, 1.0);
	...
	materials[4].Color = vec3(0.0, 0.0, 0.7);
	...
	materials[6].Color = vec3(1.0, 0.8, 0.0);
	...
	materials[7].Color = vec3(1.0, 0.0, 0.0);
